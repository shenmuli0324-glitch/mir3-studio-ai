...
pub fn handler() -> impl Fn(Invoke<Wry>) -> bool + Send + Sync + 'static {
    let generated: fn(Invoke<Wry>) -> bool = tauri::generate_handler![
        ...
        crate::bridge::domain_reference_query,
        crate::bridge::domain_unclaimed_file_query,
        crate::bridge::domain_binding_list,
        crate::bridge::domain_binding_add,
        crate::bridge::domain_binding_remove,
        ...
        crate::bridge::user_capability_compile_global,
        crate::bridge::user_capability_get,
        crate::bridge::user_capability_promote,
        crate::bridge::user_capability_resolve,
        crate::bridge::user_capability_rollback,
        crate::bridge::user_capability_set_shared_status,
        crate::bridge::user_capability_set_status,
        crate::bridge::user_capability_validate_global,
        crate::bridge::user_capability_versions,
        ...
        crate::bridge::core_mcp_canary_run,
