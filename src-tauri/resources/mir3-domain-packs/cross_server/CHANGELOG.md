...
- Added the cross-server-route-record resource schema with typed fields, unique keys, references, client/engine consistency, and runtime diagnostics.
- Added parameterized safe operations backed by the graph primitive.
