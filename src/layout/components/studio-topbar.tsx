...
export function StudioTopbar({ activeView, sidebarCollapsed, iframeRef, showSidebarToggle, onToggleSidebar }: {
  ...
  return (
    <header className="flex h-11 w-full shrink-0 select-none items-center gap-1 border-b border-line bg-panel px-1.5">
      ...
      <div className="ml-1 flex min-w-0 items-center gap-2">
        ...
        <span className="hidden text-[11px] text-muted min-[760px]:inline">{t('studio.shell.no_project')}</span>
      </div>
